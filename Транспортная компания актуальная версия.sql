...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 02 2024 г., 14:59
...
INSERT INTO `route` (`ID`, `Наименование`, `Тариф_за_1_кг`, `Расстояние`, `изображение`) VALUES
(100, 'Сургут - Нефтеюганск', 4, 46, 'https://i.postimg.cc/X7ggdn7h/image.png'),
(101, 'Сургут - Нижневартовск', 7, 222, 'https://i.postimg.cc/HngQ8NGd/image.png'),
(102, 'Сургут - Лянтор', 5, 92, 'https://i.postimg.cc/dtJ2qgm9/image.png');
...
INSERT INTO `transport` (`ID`, `Наименования`, `Грузоподъёмность`, `изображение`) VALUES
(10, 'ГАЗ-3302', 3500, 'https://cdna.artstation.com/p/assets/images/images/010/816/262/medium/nail-khusnutdinov-als-181-010-gaz-3302-central-page-3x.jpg?1526385733'),
(11, 'ЗИЛ-130', 5000, 'https://agro-tm.ru/wp-content/uploads/0/1/5/015ae267ca31cb424c2e96fe63d0cbff.jpeg'),
(12, 'КамАЗ-65115', 15000, 'https://st32.stpulscen.ru/images/product/339/889/343_big.jpg');
...
(100000, 'Данил', 'gatiyatov_dd@edu.surgu.ru', '202cb962ac59075b964b07152d234b70'),
(100001, 'Ваня', 'Vanya@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99');
...
--
ALTER TABLE `users`
  MODIFY `ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100002;
